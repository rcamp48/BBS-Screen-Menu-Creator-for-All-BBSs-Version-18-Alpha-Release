...
IF t1a = t1b THEN GOTO trulyrandom
IF t1a = t1c THEN GOTO trulyrandom
IF t1a = t1d THEN GOTO trulyrandom
IF t1a = t2 THEN GOTO trulyrandom
IF t1b = t2 THEN GOTO trulyrandom
IF t1c = t2 THEN GOTO trulyrandom
IF t1d = t2 THEN GOTO trulyrandom
