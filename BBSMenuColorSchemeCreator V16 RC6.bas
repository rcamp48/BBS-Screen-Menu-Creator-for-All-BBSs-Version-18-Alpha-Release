...
IF ran = "F" THEN GOTO inputscreen
...
back1b:
GOSUB background
INPUT "Outside Lines Background 1a [From 0 to  7] : ", g1b
INPUT "Outside Lines Foreground 1a [From 0 to 15] : ", t1b
PRINT
COLOR t1b, g1b
...
back1c:
GOSUB background
INPUT "Outside Lines Background 1a [From 0 to  7] : ", g1c
INPUT "Outside Lines Foreground 1a [From 0 to 15] : ", t1c
PRINT
COLOR t1c, g1c
...
back1d:
GOSUB background
INPUT "Outside Lines Background 1a [From 0 to  7] : ", g1d
INPUT "Outside Lines Foreground 1a [From 0 to 15] : ", t1d
PRINT
COLOR t1d, g1d
...
etry8:
GOSUB background
INPUT "Color # 8 of 8 -- Background [From 0 to  7] : ", color8background
INPUT "Color # 8 of 8 -- Foreground [From 0 to 15] : ", color8foreground
PRINT
...
COLOR 7, 0
PRINT
PRINT "This is what you get for colors [Is it still readable] [Y] or [N] : "
...
IF t = t1a OR t = t2 THEN GOTO trulyrandom
IF g = g1b OR g = g2 THEN GOTO trulyrandom
IF t = t1c OR t = t2 THEN GOTO trulyrandom
IF g = g1c OR g = g2 THEN GOTO trulyrandom
IF t = t1d OR t = t2 THEN GOTO trulyrandom
